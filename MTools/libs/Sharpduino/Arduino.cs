...
namespace Sharpduino
{
    public class Arduino: IDisposable
    {
        ...
        public void SetServoMode(int pin, int minPulse, int maxPulse, int startAngle)
        {
        ...
        public void SetDO(int pin, bool newValue)
        {
            if (firmata.IsInitialized == false)
                return;
        ...
        public void SetPWM(int pin, int newValue)
        {
            if (firmata.IsInitialized == false)
                return;
        ...
        public float ReadAnalog(int pin)
        {
            if (firmata.IsInitialized == false)
                return -1;
        ...
        public int ReadDigital(int pin)
        {
            if (firmata.IsInitialized == false)
                return -1;
